...
class _RoomStoreScreenState extends State<RoomStoreScreen> {
  ...
  final List<Product> productsAvilable = [
    ...
    Product(productName: "prod 2", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 3", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 4", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 5", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 6", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 7", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 8", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 9", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 10", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 11", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 12", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
    ),
    Product(productName: "prod 13", description: "description", type: 1, idProduct: 1, 
      activate: 0, 
      state: true, 
      compounds: [],
      promos: [],
